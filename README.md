...
I used alacritty coupled with tmux for a very long, but recently I decided to ditch tmux and
...
One day I decided to try [fish](https://fishshell.com) and really liked it.
Its pretty amazing out-of-the-box: it comes with syntax-highlighting, auto-completion and
suggestions, a script formatter, etc.
...
in love, as I'm a big Hokusai admirer and have some prints myself. I try to use it everywhere is possible.
